...
| P4 | Fold-down table | spatial reasoning, transformation | rotating/latching table with etched compass rose | frequencies, etched compass rose | table orientation changes the dial meaning | bearing word | reset table latch |
...
| P3 | P4 | frequency digits unlock table clue | operator can reveal one missing object |
| P4 | P5 | bearing word disambiguates final tuning | final acceleration card at hard-exit minus 3 |
